          ...
          <div className="flex flex-row gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xl text-[#D7D7D7]">
                Em um mundo onde as leis estão em constante evolução, é crucial
                ter ao seu lado uma equipe de advogados que compreende
                profundamente o cenário legal. Nossa consultoria oferece
                soluções personalizadas que visam proteger seus interesses e
                mitigar riscos. Com um compromisso inabalável com a excelência,
                trabalhamos para antecipar desafios futuros e oferecer
